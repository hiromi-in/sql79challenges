## Uber(Hard Level) hashtag#SQL Interview Question
...
### Comment:
I needed to understand what the question is asking.  
I do not use LAG() or LEAD() function often so these functions are not my first options to use.  
After looking at the example solution, I also tried LAG() funtion.  
With the function, the code got shorter and hence it is easier to understand what the sctipt was trying to do.  
The more we write, the more we know and understand.  
I should ask my boss to give me more projects. haha